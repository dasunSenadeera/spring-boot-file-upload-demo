...
public class FileController {
    ...
    public UploadedFiles uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        return fileUploadRepository.save(new UploadedFiles(fileName, fileDownloadUri,
                file.getContentType(), file.getSize()));
    }

    @PostMapping("/uploadMultipleFiles")
    public List<UploadedFiles> uploadMultipleFiles(@RequestParam("files") MultipartFile[] files) {
